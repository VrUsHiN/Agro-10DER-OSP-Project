...
<form id="create_bid" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
...
$("#create_bid").submit(function(event){
    ...
    // Let's select and cache all the fields
	 $("#aswe").prop("disabled", false)
 $("#aswee").prop("disabled", false)
    ...
    $.post("<?php echo $_SERVER['PHP_SELF'];?>", serializedData, function(response) {
