...
<!-- ////////////////body//////////////////////////////////////// -->
  ...
  <img src="images\agriculture.jpg" style="width:100%;height:750px">
  <div class="mainbody">
...
<div class="row">
  ...
  <div class="card shadow p-4 mb-4 bg-white">
    ...
    <div class="card-body cx">
      <b><h5 class="card-title">Fertilizers</h5></b>
      <p class="card-text just">Procurement of bio fertilizer (azospirrilumphosphobacteria) and bio control agent (pseudomonas)<br><br></p>
      <br>
  ...
  <div class="card shadow p-4 mb-4 bg-white">
    <!-- <img src="images\firstimage.jpg" class="card-img-top" alt="..."> -->
    <div class="card-body cx" >
      <h5 class="card-title">Latest Agro Equipments</h5>
      <p class="card-text just">Supply and installation of different agricultural implements in different districts of west bengal up to g.p level.</p><br><br>
...
<div class="container bg-white shadow pt-5">
  ...
  <div class="row mt-4">
	...
	<br>
      <h2>EXPAND</h2>
      <p>A businessman needs links, a businessman needs contacts. The more farmer you interact with, the greater the chance of expanding your ideas. We, at 10der, trust that more than technology, the people are more important. Hence, we have framed a system that helps farmer make contacts with businessmen and businessmen expand their business.
	  </p>
      <p>What's in it for them? Its a 2-way-benefit: farmer gets hold of innovative businessmen, while businessmen have chance to expand their trade, thereby pushing the geographical limits</p>
    </div>
   ...
   <div class="row mt-4 ">
	...
	<br>
      ...
      <p>
      With more options, the farmer has the freedom to choose only the best of the best. If there are any issues with the business link formed with a person, the farmer can quickly shift the business link to a more trustworthy provider. The abundance of options helps farmers to choose the best product/ service. We believe that quality and quantity are highly important, and hence it is necessary for each and every farmer to use his/her rights to spend money only on the best product/ service.
	  
	  </p><p>The quality of service/ product demanded using this portal is hence, guaranteed to be a class apart, due to high competency amongst the businessmen to attract farmers. Enhancement of quality-checked!</p>
    </div>
   ...
   <div class="row mt-4">
    ...
    <div class="col-lg-6 mt-4 mb-4">
      ...
      <p>We at 10der, believe that cost efficiency is the key to develop a better farmer-businessman relationship. Due to high competency of businessmen, it becomes very probable for farmers to expect prices far below than the offline price. In the trade-war, <b>price falls</b> become a common aspect. Consumers from various fields hence tend to use this portal for getting better offers, and more cost-effecient 2/ services
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row text-center text-md-left mt-3 pb-3">
      ...
      <div id="contact" class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3 text-white text-left homefont">
        ...
        <p>
          <i class="fas fa-envelope mr-3"></i> 10derteam@gmail.com</p>
       
        <p>
          <i class="fas fa-print mr-3"></i> +91 8798587465</p>
           <p>
          <i class="fas fa-print mr-3"></i> +91 9578457454</p>
      </div>
      <!-- Grid column -->
